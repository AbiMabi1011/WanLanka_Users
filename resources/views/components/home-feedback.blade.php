<div class="feedback-container" aria-label="Feedback Carousel" data-aos="fade-up">
    <div class="feedback-wrapper">
        <div class="feedback-item active card-3d" role="group" aria-roledescription="slide" aria-label="Feedback 1 of 3">
        ...
        <div class="feedback-item card-3d" role="group" aria-roledescription="slide" aria-label="Feedback 2 of 3">
            <div class="avatar" aria-hidden="true">
                <i class="fas fa-user"></i>
            </div>
            <div class="rating" aria-label="5 star rating">
        ...
        <div class="feedback-item card-3d" role="group" aria-roledescription="slide" aria-label="Feedback 3 of 3">
            <div class="avatar" aria-hidden="true">
                <i class="fas fa-user"></i>
            </div>
            <div class="rating" aria-label="5 star rating">
