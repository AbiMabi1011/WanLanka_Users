<section class="packages-section">
    <div class="container">
        <div class="section-header" data-aos="fade-down">
            <h2 class="section-title text-neon">Special Tour Packages</h2>
            <p class="section-subtitle">Discover our exclusive offers with limited-time discounts</p>
        </div>

        <div class="offers-carousel">
            <!-- Offer 1 -->
            <div class="offer-card card-3d" data-aos="zoom-in" data-aos-delay="100">
            ...
            <!-- Offer 2 -->
            <div class="offer-card card-3d" data-aos="zoom-in" data-aos-delay="200">
                <div class="card-front">
            ...
            <!-- Offer 3 -->
            <div class="offer-card card-3d" data-aos="zoom-in" data-aos-delay="300">
                <div class="card-front">
            ...
            <!-- Offer 4 -->
            <div class="offer-card card-3d" data-aos="zoom-in" data-aos-delay="400">
                <div class="card-front">
            ...
            <!-- Offer 5 -->
            <div class="offer-card card-3d" data-aos="zoom-in" data-aos-delay="500">
                <div class="card-front">
