    ...
    <div class="container">
        <div class="about-content">
            <div class="section-header" data-aos="fade-down">
                <h2 class="section-title text-neon">Discover WanLanka</h2>
                <div class="section-divider"></div>
                <p class="section-subtitle">Your Gateway to Sri Lankan Wonders</p>
            </div>

            <div class="about-grid">
                <div class="about-text glass-card card-3d" data-aos="fade-right">
                ...
                <div class="services-container glass-card card-3d" data-aos="fade-left">
                    <h3>Our Premium Services</h3>
                    <div class="services-grid">
                        <div class="service-item float-anim" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <div class="service-item float-anim" data-aos="zoom-in" data-aos-delay="200">
                            <div class="service-icon">
                        ...
                        <div class="service-item float-anim" data-aos="zoom-in" data-aos-delay="300">
                            <div class="service-icon">
                        ...
                        <div class="service-item float-anim" data-aos="zoom-in" data-aos-delay="400">
                            <div class="service-icon">
