  ...
  <div class="wl-container wl-container-fluid">
    ...
    <nav class="wl-menu-primary" aria-label="Main">
      <ul class="wl-menu">
        ...
        <li class="{{ request()->is('steamlanka') ? 'active' : '' }}"><a href="{{ route('steamlanka') }}">SteamLanka</a></li>
...
/* Topbar */
.wl-topbar{background:rgba(255, 255, 255, 0.95);backdrop-filter:blur(12px);border-bottom:1px solid rgba(0,0,0,0.08)}
.wl-sticky{position:sticky; top:0; z-index:1000}
