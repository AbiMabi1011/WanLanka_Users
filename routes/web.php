...
Route::get('/steamlanka', [App\Http\Controllers\SteamLankaController::class, 'index'])->name('steamlanka');
Route::get('/api/sri-lanka-videos', [App\Http\Controllers\SteamLankaController::class, 'fetchSriLankaVideos'])->name('api.sri-lanka-videos');
Route::post('/api/upload-video', [App\Http\Controllers\SteamLankaController::class, 'uploadVideo'])->name('api.upload-video');

// Test routes
Route::get('/test-video-upload', function() {
    return view('test-video-upload');
});
Route::get('/test-videos', function() {
    return view('test-videos');
});
